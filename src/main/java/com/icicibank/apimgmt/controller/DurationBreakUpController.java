...
public class DurationBreakUpController {
	...
	@ResponseBody
	public ResponseEntity<ResponseModel> getDurationBreakupDetails(@RequestBody DurationDetails durationDetails) throws JsonProcessingException, InvalidDatePeriod {
